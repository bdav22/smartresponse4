...
//void main() => runApp(MyLocatorExample());

class MyLocatorExample extends StatefulWidget {
  @override
  _MyLocatorExampleState createState() => _MyLocatorExampleState();
}

class _MyLocatorExampleState extends State<MyLocatorExample> {
